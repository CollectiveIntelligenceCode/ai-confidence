...
const entries = [
  {
    ...
    cta: 'Apply to Join',
    microcopy: 'Applications are reviewed to ensure the cohort remains focused, practical and high-value.',
    modal: 'cohort' as ModalVariant,
    dark: false,
  },
  {
    n: '02',
    ...
    cta: 'Attend AI Confidence Day',
    microcopy: 'A practical leadership experience designed to help senior leaders move from AI uncertainty to action.',
    modal: 'leaders' as ModalVariant,
    dark: true,
  },
  {
    n: '03',
              ...
              <FadeIn key={i} delay={i * 120}>
                <div className={`flex flex-col h-full ${entry.dark ? 'bg-[#111111]' : 'bg-white'} border ${entry.dark ? 'border-white/8' : 'border-black/8'}`}>
                  ...
                  <div className={`p-8 border-b flex-1 ${entry.dark ? 'border-white/8' : 'border-black/8'}`}>
                    <p className="text-[#D4AF37] text-[10px] tracking-[0.2em] uppercase font-sans mb-5">
                      {entry.learnLabel}
                    </p>
                  ...
                  <div className="p-8">
                    <button
                      onClick={() => setActiveModal(entry.modal)}
                      className={`w-full text-center text-[10px] tracking-[0.25em] uppercase py-4 border transition-all duration-400 font-sans cursor-pointer ${
                        entry.dark

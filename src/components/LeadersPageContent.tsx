...
type ModalVariant = 'leaders_waitlist' | 'leaders' | 'private';

const exploreItems = [
  'AI strategy and opportunity mapping',
  'Operating models for AI-native organisations',
  ...
  'Adoption roadmaps that actually get implemented',
  'Measuring AI impact and ROI',
  'Board-level communication and confidence',
];

const personas = [
  {
    label: 'CxO or Board Member',
    desc: 'You need to lead AI transformation but feel uncertain where to start and what to prioritise.',
  },
  {
    label: 'Senior Leader',
    desc: 'AI is discussed in every boardroom. You want to own the topic, not just participate in it.',
  },
  {
    label: 'Director or Department Head',
    desc: 'You need a strategy for your function, not just a list of tools.',
  },
];

const faqs = [
  {
    q: 'When is the next AI Confidence Day for Leaders?',
    a: 'Our most recent event sold out quickly. We are building the waitlist for the next date now. Join to be notified before we open publicly, with priority booking.',
  },
  {
    q: 'Is this for people with no AI experience?',
    a: 'Yes. The day is designed for senior leaders who understand the strategic importance of AI but want to build the confidence and clarity to lead it, regardless of technical background.',
  },
  {
    q: 'What does the day involve?',
    a: 'A focused, practical leadership experience combining expert sessions, peer discussion and applied strategy work. You leave with clarity, a draft strategy and real confidence, not just slides.',
  },
  {
    q: 'Can we bring this to our organisation?',
    a: 'Yes. We design bespoke AI Confidence programmes for leadership teams and boards. Use the private day enquiry link below to start a conversation.',
  },
];

export default function LeadersPageContent() {
    ...
    <>
        ...
        <div className="max-w-3xl mx-auto px-6 text-center">
          <FadeIn>
            ...
            <h1 className="font-serif text-white text-[clamp(2.6rem,6vw,4.8rem)] leading-[1.05] mb-6">
              AI Confidence<br />
              <span className="italic text-white/50">for Leaders</span>
            </h1>
            <p className="text-white/60 text-base leading-relaxed mb-10 max-w-xl mx-auto font-sans">
              Build the clarity, strategy and confidence to lead AI transformation, and stop nodding along in conversations about a topic you don&apos;t yet own.
            </p>
            <button
              ref={heroCtaRef}
              onClick={() => setModal('leaders_waitlist')}
            ...
            <p className="text-white/30 text-[11px] font-sans mt-5 tracking-wide">
              Free to join · First access to the next AI Confidence Day
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <div className="bg-[#D4AF37] py-4 text-center">
        <p className="font-sans text-[#111111] text-[11px] tracking-[0.25em] uppercase">
          Previous event sold out — join the waitlist now for priority access
        </p>
      </div>
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="max-w-5xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <p className="text-[#D4AF37] text-[10px] tracking-[0.35em] uppercase font-sans mb-4">You will explore</p>
            <h2 className="font-serif text-[#111111] text-[clamp(2rem,4vw,3rem)] leading-tight mb-12 max-w-xl">
              The strategic foundations every leader needs.
            </h2>
          </FadeIn>
      ...
      <div className="relative h-[42vw] max-h-[480px] min-h-[240px] overflow-hidden">
        <Image
          src="/images/3.jpeg"
          alt="Senior leadership team in a boardroom strategy session with a facilitator presenting AI opportunities"
          fill
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-12">
          <FadeIn>
            ...
            <h2 className="font-serif text-[#111111] text-[clamp(2rem,4vw,3rem)] leading-tight mb-12">
              Designed for those who set the direction.
            </h2>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            <FadeIn>
              ...
              <div className="flex flex-wrap gap-3">
                {['Workshops', 'Executive sessions', 'Leadership cohorts', 'Advisory support'].map((f, i) => (
            ...
            <FadeIn delay={100}>
              ...
              <ol className="space-y-6">
                {[
                  'Learn — understand AI at a strategic level',
                  'Apply — map opportunities in your organisation',
                  'Adapt — build your leadership approach',
                  'Future-Proof — lead with confidence from day one',
                ].map((step, i) => (
        ...
        <div className="max-w-2xl mx-auto px-6">
          <FadeIn>
            ...
            <div className="mt-6">
              ...
              >
                Enquire about a private day for your leadership team →
              </button>
            </div>
          </FadeIn>
        </div>

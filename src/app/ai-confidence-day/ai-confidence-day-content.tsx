...
const testimonials = [
  ...
  { name: 'Dan Brown', role: 'International Sales Director, Dailymotion', q: 'Rujata has a rare ability to translate complexity into something actionable. I left with a framework I actually used in a board meeting the following week.' },
  ...
  { name: 'Evelyn Truter', role: 'Marketing Director, Ricoh Europe', q: 'Rujata delivered transformative insights and inspired us to translate ideas into tangible, high-impact projects. A remarkable experience.' },
...
export default function AIConfidenceDayContent() {
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            {[
              ...
              { title: 'Facilitated, Not Lectured', desc: 'Rujata and Chris have run these rooms before. They know how to create the conditions for real thinking. Past attendees ask when the next one is.' },
